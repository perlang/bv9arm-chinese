...
.. warning::
   ...
   在影响的完整理解之前，不应该更改默认值。参见 :rfc:`9276` 。
...
在进一步讨论之前，值得注意的是，如果您使用 :any:`dnssec-policy` ，
您实际上不需要关心密钥轮转的细节：BIND 9会为您处理所有这些问题。如果
您正在进行手动密钥轮转，那么您确实需要熟悉所涉及的各个步骤和时间细节。
...
为你处理这些步骤。只需更改相关密钥的算法，然后 :iscman:`named` 在下次轮转

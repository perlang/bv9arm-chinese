...
BIND 9.16 （延长支持版）是BIND 的一个稳定分支。本文档汇总了此分支上自上
一个产品版本以来的重大变化。关于变化和漏洞修订的一个更详细的清单，请参
见CHANGES文件。
...
BIND 9.16（延长支持版）将会至少支持到2023年12月。
参见 https://kb.isc.org/docs/aa-00896 以获取ISC的软件支持策略的详细信
息。

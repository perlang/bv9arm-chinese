...
``named.conf`` 是 ``named`` 的配置文件。语句用大括号括起来，并以分号结束。
...
:manpage:`named(8)`, :manpage:`named-checkconf(8)`, :manpage:`rndc(8)`, :manpage:`rndc-confgen(8)`, :manpage:`tsig-keygen(8)`, BIND 9管理员参考手册。
